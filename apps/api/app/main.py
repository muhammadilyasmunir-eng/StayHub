...
OWNER_ROOM_AMENITIES_SCRIPT='<script src="/static/owner-room-amenities.js?v=1"></script>'
...
def admin_panel():
    ...
    if "admin-final-review-ui-fix.js?v=1" not in html: html=html.replace("</body>",scripts+"</body>")
        ...
        if "admin-property-media-manager.js?v=1" not in html: html=html.replace("</body",'<script src="/static/admin-property-media-manager.js?v=1"></script></body>')
        if "admin-media-view-modal.js?v=1" not in html: html=html.replace("</body",'<script src="/static/admin-media-view-modal.js?v=1"></script></body>')
