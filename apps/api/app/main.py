...
def owner_portal():
    ...
    if "owner-rejection-workflow-v2.js" not in html: html=html.replace("</body>",scripts+"</body>")
        ...
        for marker in ("owner-calendar.js?v=2","owner-terms-workflow.js?v=4","owner-commission-display-fix.js?v=2","owner-billing-readonly.js?v=1","owner-reservation-detail-fix.js?v=5","owner-reservations-ui.js?v=2","owner-reservation-label-fix.js?v=3","date-defaults.js?v=3","owner-reservation-actions.js?v=3","owner-no-show-detail-ui.js?v=4","owner-room-inventory-photos.js?v=15","owner-room-category-actions.js?v=1","owner-reservation-navigation-fix.js?v=1","owner-room-add-button-fix.js?v=1","owner-reservation-encoding-fix.js?v=1","owner-notification-center.js?v=4","owner-customer-messages-ui.js?v=1","owner-customer-messages-override.js?v=1","owner-reviews-ui.js?v=1"):
